...
class EasyPlugin
{
    public function __construct()
    {
        ...
        // méthode d'inscription de la fonction de création des options du plugin
    ...
    public function menu_admin_html()
    {
        ...
        echo '<p>Bienvenu sur la page d\'accueil du plugin</p>';
    ...
    public function register_settings()
    {
        ...
        add_settings_field('easy_newsletter_object', 'Object', array($this, 'object_html'), 'easy_newsletter_settings', 'easy_newsletter_section');
    ...
    function mailer_config( $mailer)
    {
        ...
        $mailer->SMTPAuth = true; // Activer authentification SMTP
        $mailer->Username = 'nab.aourach@gmail.com'; // Votre adresse email d'envoi
        $mailer->Password = 'ronaldino2'; // Le mot de passe de cette adresse email
        $mailer->SMTPSecure = 'tls'; // Accepter SSL
        $mailer->Port = 587;      // Le port
